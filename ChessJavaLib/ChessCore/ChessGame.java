...
public abstract class ChessGame {
    ...
    private ArrayList<Move> saved=new ArrayList();
    ...
    public boolean makeMove(Move move) {
        ...
        //Piece toPiece=board.getPieceAtSquare(tosquare);
        /*if(toPiece instanceof Pawn)
        {
            System.out.println(toPiece.getOwner());
        }*/
    ...
    public Piece getPieceAtSquare(Square square) {
     ...
     public void SaveMoves(Move m)
     {
         saved.add(m); 
     }
     public ArrayList<Move> getSavedMoves()
     {
         return saved;
     }
     ...
     public void SavecapturedPieces(Square s)
     {
         Piece p=board.getPieceAtSquare(s);
         captured.add(p);
     }
     ...
     public void ReverseMove(Move m,Piece p)
     {
        ...
        {
            board.setPieceAtSquare(FromSquare, null);
            board.setPieceAtSquare(m.getToSquare(), FromPiece);
        }
        else
        {
            board.setPieceAtSquare(FromSquare, p);
            board.setPieceAtSquare(m.getToSquare(), FromPiece);
        }
...
//if()
       /* if (FromPiece instanceof King &&
            ...
            Square toSquare = m.getToSquare();
            if (toSquare.getFile() == BoardFile.E && toSquare.getRank() == BoardRank.FIRST) {
                // White king-side castle.
                // Rook moves from H1 to F1
                Square h1 = new Square(BoardFile.H, BoardRank.FIRST);
                Square f1 = new Square(BoardFile.F, BoardRank.FIRST);
                Piece rook = board.getPieceAtSquare(f1);
                board.setPieceAtSquare(h1, rook);
                board.setPieceAtSquare(f1, null);
            }*/
     }
